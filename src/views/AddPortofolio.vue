<template>
	<section>
		...
		<div class="container">
			...
			<div class="col">
				<form method="POST" enctype="multipart/form-data" @submit.prevent="addPortofolio">
					<div class="control">
					...
					<div class="control">
						...
						<input type="file" class="upload" ref="photo" @change="upload"  id="upload">
					</div>
					<div class="control">
...
<script>
	...
	export default {
		...
		methods: {
			...
			addPortofolio: async function() {
				const formData = new FormData();
				formData.append('title', this.title);
				formData.append('description', this.description);
				formData.append('photo', this.photo);

				const res = await HTTP.connect('post', '/portofolio', formData, this.$session.get('token'));
